...
#       nonfunctional, but you have some other compliant shell available, you may
...
#       export SHELL
#
#   (2) The slightest modification of this script breaks it all.  Just
#       don't touch it if you don't understand how it works.
#
##############################################################################
